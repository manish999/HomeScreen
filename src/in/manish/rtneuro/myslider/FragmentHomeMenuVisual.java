...
public class FragmentHomeMenuVisual extends SherlockListFragment
{
	...
	public static FragmentHomeMenuText newInstance() {
		FragmentHomeMenuText fragment = new FragmentHomeMenuText();
		return fragment;
	}
